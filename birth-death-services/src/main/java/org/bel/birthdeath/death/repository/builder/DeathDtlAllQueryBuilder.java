...
public class DeathDtlAllQueryBuilder {
    ...
    private static String QUERY_Master_All = "SELECT bdtl.id deathdtlid, bdtl.tenantid tenantid, registrationno, dateofdeath, CURRENT_TIMESTAMP  as dateofissue , counter, gender , "
