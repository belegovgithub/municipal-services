...
public class TLConstants {
    ...
    public static final List<String> NOTIFICATION_CODES = Collections.unmodifiableList(Arrays.asList(
            ...
            NOTIFICATION_FORWARD_CITIZEN,NOTIFICATION_TL_REMINDER,NOTIFICATION_APPFEE_PAYMENT_PAYER,NOTIFICATION_APPFEE_PAYMENT_OWNER,NOTIFICATION_PENDINGAPPROVAL));
