...
@Component
public class BillingSlabRowMapper implements ResultSetExtractor<List<PgDetail>> {

	/**
	 * Rowmapper that maps every column of the search result set to a key in the model.
	 */
	@Override
	public List<PgDetail> extractData(ResultSet rs) throws SQLException, DataAccessException {
		Map<String, PgDetail> billingSlabMap = new HashMap<>();
//		while (rs.next()) {
//			String currentId = rs.getString("id");
//			PgDetail currentBillingSlab = billingSlabMap.get(currentId);
