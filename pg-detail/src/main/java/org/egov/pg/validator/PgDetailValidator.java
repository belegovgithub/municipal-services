...
@Service
@Slf4j
public class PgDetailValidator {
...
//	private PgDetailService service;
	 ...
	 */
	public void validateCreate(PgDetailRequest billingSlabReq) {
		Map<String, String> errorMap = new HashMap<>();
		Object mdmsData = util.mDMSCall(billingSlabReq);
		System.out.println("mdms data");
