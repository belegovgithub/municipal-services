...
public class SearchCriteria {
	...
	private Long bookedFromDate = null;

	private Long bookedToDate = null;
	...
	public String toString() {
		return "SearchCriteria [tenantId=" + tenantId + ", ids=" + ids + ", tenantIds=" + tenantIds + ", userIds="
				...
				+ ", status=" + status + ", fromDate=" + fromDate + ", toDate=" + toDate + ", hallId=" + hallId
				+ ", bookedFromDate=" + bookedFromDate + ", bookedToDate=" + bookedToDate + "]";
	}
